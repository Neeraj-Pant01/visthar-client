  ...
  return (
    <div className='flex w-[440px] py-2 bg-[#f4f0f0] rounded-lg px-1'>
      <div className='flex flex-[1.7] flex-col relative'>
        <img src='https://cdn.shopify.com/s/files/1/0057/8938/4802/files/121v2.png?v=1701427775' className='b-top-r cursor-pointer w-[100%] md:h-[200px] h-[150px] b-top-r' alt='' onClick={()=>navigate(`/product/1234`)}/>
